...
public String toString() {
    return  String.format("Name - %s Surname - %s: Years expirience %d, english level - %s, salary - %d",this.name,this.surname,this.expirienceInYears, this.englishLevel, this.salary);
}
}
