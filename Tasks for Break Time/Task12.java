...
public class Task12 {
	public void removeComments(String fileName) {
		...
		try {
			...
			while ((ch = reader.read()) != -1) {
				...
				if (startDoubleQuoteFound && (starCommentFound == true || slashCommentFound == true))
					continue;
				...
				if (ch == '/') {
					...
					else if (firstSlashFound && slashCommentFound == false && starCommentFound == false) {
						slashCommentFound = true;
						firstSlashFound = false;
						continue;
					}

					else if (slashCommentFound == false && starCommentFound == false
				...
				if (ch == '*') {
					...
					else if (startOfComment == false && starCommentFound == true) {
						startOfComment = true;
						continue;
					}
				}
	...
	public static void main(String[] args) {
		Task12 reader = new Task12();
		reader.removeComments("C:\\\\enterAPathOfFile.java");
	}
